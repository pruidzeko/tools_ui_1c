...
Процедура УстановитьСхемуКомпоновкиДанныхКлиент(Схема, ИдентификаторСтроки = Неопределено)
	...
	УстановитьСхемуКомпоновкиДанныхКлиентФрагмент(ЗагружатьНастройкиПоУмолчанию, Схема, ИдентификаторСтроки);
КонецПроцедуры
...
Процедура УстановитьСхемуКомпоновкиДанныхКлиентЗавершение(РезультатВопроса, ДополнительныеПараметры) Экспорт
	...
	УстановитьСхемуКомпоновкиДанныхКлиентФрагмент(ЗагружатьНастройкиПоУмолчанию,
												  Схема,
...
&НаКлиенте
Процедура УстановитьСхемуКомпоновкиДанныхКлиентФрагмент(ЗагружатьНастройкиПоУмолчанию, Схема, ИдентификаторСтроки)
...
Процедура УстановитьСхемуКомпоновкиДанных(Схема, ЗагружатьНастройкиПоУмолчанию, ИдентификаторСтроки = Неопределено)
	...
	ИначеЕсли ТипЗнч(Схема) = Тип("Строка") Тогда 
